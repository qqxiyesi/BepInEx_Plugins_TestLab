...
namespace Gravure
{
	...
	{
		public const string GUID = "mikke.Gravure";
		public const string PluginName = "Gravure";
		public const string Version = "1.4.1.2";
		...
		private void FindSliders(Transform setting2, out CustomSliderSet glossSet, out CustomSliderSet textuSet)
		{
			...
			{
				Logger.LogError("Did not find gloss and textrure sliders");
			}
		...
		{ { "studio/anime/03.unity3d", "gravure", "abdata", "tachi_00" }, { "studio/anime/08.unity3d", "action_08", "abdata", "dance_00" }, { "studio/anime/03.unity3d", "dance", "abdata", "poledance_00" }, { "studio/anime/08.unity3d", "f_cutin", "abdata", "FightA_cutin_00" }, { "studio/anime/00.unity3d", "tpose", "abdata", "tpose" }, { "studio/anime/00.unity3d", "f_studio", "abdata", "mc_f_move_00" }, { "studio/anime/00.unity3d", "f_studio", "abdata", "mc_f_pose_00_in" }, { "studio/anime/00.unity3d", "f_studio", "abdata", "action_00" }, { "studio/anime/00.unity3d", "f_studio", "abdata", "action_38" }, { "studio/anime/00.unity3d", "f_studio", "abdata", "sleep_01_00" },
		};
		...
		private string[][] gravureAnims = new string[][]
		{
			...
			new []
			{
				// studio/anime/00.unity3d tpose tpose
				"tpose"
			},
			new []
			{
